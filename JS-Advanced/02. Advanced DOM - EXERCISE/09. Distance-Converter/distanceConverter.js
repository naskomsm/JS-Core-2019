function attachEventsListeners() {
    ...
    function onClick(){
        ...
        let fromMenu = document.getElementById('inputUnits');
        var fromSelectedOption = fromMenu.options[fromMenu.selectedIndex].value; // km / m / miles etc...
        
        let toMenu = document.getElementById('outputUnits');
        var toSelectedOption = toMenu.options[toMenu.selectedIndex].value; // km / m / miles etc...
        
        let convertedDistance = converter[fromSelectedOption][toSelectedOption](inputValue);
